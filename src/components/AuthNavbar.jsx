      ...
      <section className="container">
        <nav className="flex justify-between items-center py-[16px] gradient-border gap-[26px]">
          <div className="flex items-center gap-[15px]">
            <img src="/logov2.svg" className="w-[70px] cursor-pointer" />
            <h2 className="text-[22px] text-white">Password Manager</h2>
          </div>
          <div className="flex-1 items-center gap-[18px] hidden lg:flex">
            ...
            <div className="flex gap-[19px]">
              <Link className="w-[61px] h-[61px] py-[19px] px-[18px] bg-[#101E71] border-[.3px] border-[#374CC4] rounded-full">
                <Shield />
              </Link>
              <Link to='/dashboard/add' className="w-[61px] h-[61px] py-[19px] px-[18px] bg-[#101E71] border-[.3px] border-[#374CC4] rounded-full">
                <Add />
              </Link>
              <Link className="w-[61px] h-[61px] py-[19px] px-[18px] bg-[#101E71] border-[.3px] border-[#374CC4] rounded-full">
                <Save />
